      ...
      <div className="w-full flex justify-center px-6">
        <div className="w-full max-w-5xl">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 mb-16">
            ...
            >
              Всё для работы специалиста по охране труда
            </motion.h2>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <p className="text-zinc-400 leading-relaxed">
                Платформа объединяет актуальную нормативно-правовую базу, систему обучения персонала
                и автоматизацию документооборота в единый инструмент для специалистов по охране труда.{" "}
